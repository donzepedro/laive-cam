...
<div class="wrapper">
        <div class="header">
            ...
            <div class="headmenu">
                ...
                <div class="nav1">
                    <ul>
                        <li ><a href="<?= DOMAIN ?>/user/events"><?= Yii::t('commonEn', 'События'); ?></a></li>
                        <li ><a href="<?= DOMAIN ?>/user/mycameras?options=all"><img  style="width: 30px; height: 30px" src="<?= DOMAIN ?>/public/images/camimg.png"> <?= Yii::t('commonEn', 'Мои камеры'); ?></a></li>
                        <li ><a href="<?= DOMAIN ?>/user/userprofile?options=notifications"><?= Yii::t('commonEn', 'Настройки'); ?></a></li>
                    </ul>
                </div>
                <div class="accaountact">
                    <ul>
                        <li><a href="<?= DOMAIN ?>/user/exit"><?= Yii::t('commonEn', 'Выйти'); ?></a></li>
        <!--                <li><a href="<?= DOMAIN ?>/guest/createaccount">--><?//= Yii::t('commonEn', 'Регистрация'); ?><!--</a></li>-->
                ...
                <div class="langbar">
                    ...
                    <span id=<?= $lang_ru?>>
                            <?php
                            echo Html::a('Russian', array_merge(Yii::$app->request->get(),[Yii::$app->controller->route,'language'=>'ru']),['class'=>'qwe']);
                            ?>
                        </span>
                </div>
            </div>
        </div>
<!--        <div class="container"> ЦЕНТРУЕТ  КОНТЕНТ ПО ЦЕНТРУ ДЛЯ ВСЕХ-->
<!--        </div>-->
        <div class="content">
            <?= $content ?>
        </div>
