  ...
  <div class="header-row">
      <div class="header">
          <div class="headmenu">
              ...
              <div class="nav1">
                  <ul>
                      <li ><a  <?php if(Yii::$app->controller->action->id == 'events'){
                                      echo 'class="active"';
                                }?> href="<?= DOMAIN ?>/user/events"><?= Yii::t('commonEn', 'События'); ?></a></li>

                      <li ><a <?php if(Yii::$app->controller->action->id == 'mycameras'  && Yii::$app->request->get('options')=='all'){
                                      echo 'class="active"';
                               }?> href="<?= DOMAIN ?>/user/mycameras?options=all"><?= Yii::t('commonEn', 'Устройства'); ?></a></li>

                      <li ><a <?php if(Yii::$app->controller->action->id == 'userprofile' && Yii::$app->request->get('options')){
                                      echo 'class="active"';
                               } ?> href="<?= DOMAIN ?>/user/userprofile?options=settings-account"><?= Yii::t('commonEn', 'Настройки'); ?></a></li>
                  </ul>
              </div>
